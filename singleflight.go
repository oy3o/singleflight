...
func (g *Group[K, V]) Do(
	...
	c.forgotten = false
	c.panicErr = nil
	// Remove shared field from call struct and return it from doCall instead to avoid redundant memory writes and simplify the struct contract.
	// Expected impact: ~0 allocs/op, minor CPU optimization.
