...
## 2024-05-24 - Named Returns Optimization
**Learning:** Using named return variables instead of struct fields reduces struct padding and avoids heap dereferencing.
**Action:** Pass state via named return variables in hot paths.
